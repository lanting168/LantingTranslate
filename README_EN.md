...
- 🌍 **100+ language translation**: covers mainstream and minority languages, meets global needs  
- 📄 **Document translation**: supports .pdf, .docx, .xlsx, .pptx formats  
- 🎨 **Format preserved**: the layout, styles, chart positions are consistent with original text after translation  
...
```bash
Unpack and install the package, run it directly.
```
